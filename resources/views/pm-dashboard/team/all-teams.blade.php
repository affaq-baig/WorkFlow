                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <x-card title='<a href="{{route("teams.edit",["team"=>$team->id])}}" class=" fsize-2 " style="text-decoration:underline;font-weight:700">{{$team->team_name}}</a>' 
                            tab1='<b class="badge badge-danger" id="preview_cat">{{$team->category->cat_name ?? "No Category"}}</b>'
                                ...
                                <x-fancy-table-body>
                                    <tr>
                                        <td class="text-center">
                                            <div class="badge badge-info " style="font-size:100%">{{$team->teamLead->name ??'NO task lead'}}</div>
                                        </td>
